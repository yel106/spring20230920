...
@RequiredArgsConstructor //s3를 주입받을 수 있도록 함
public class Controller34 {
    ...
    public void method2(MultipartFile file) throws IOException {
        ...
        if( file != null && file.getSize() > 0) {
            ...
            s3Client.putObject(objectRequest, RequestBody.fromInputStream(file.getInputStream(), file.getSize()));  //s3의 풋오브젝트 메소드를 이용해야돼서 s3을 만들러 가야함. 메소드에 파라미터 사용
        }
    }
