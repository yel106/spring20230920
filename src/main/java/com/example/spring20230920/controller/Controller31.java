...
//        dao.select3(code, k);
        ...
        List<Map<String, Objects>> rows = dao.select3(code, "%" + k + "%");
//        Map<String, Objects> A = dao.select3(code,k ); 이렇게 써도 됨
    ...
    public void method5(MyDto36 dto, Model model) {
        ...
        model.addAttribute("customerList",dao.listCustomer(dto)); //dto의 쿼리에 따라 값이 달라짐
    }
